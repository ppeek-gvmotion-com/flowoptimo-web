        ...
        <div className='grid items-center gap-12 lg:grid-cols-2'>
          <div>
            <h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl'>
              Automate Your{' '}
              <span className='text-primary-orange'>Vacation Rental</span>{' '}
              Operations
            </h1>
            <p className='mt-6 text-lg text-gray-600'>
              FlowOptimo streamlines cleaner/ maintenance scheduling, route
              optimization, and guest communication. Save hours every week with
